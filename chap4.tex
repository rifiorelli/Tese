...
This section explains how the obtained data was prepared in order to make the comparisons between the various sources of information and exposes the results together with their analysis.
    ...
    \subsection{Analysis of results} \label{sec4:analysis_results}
        ...
        \paragraph*{Processor power analysis}
            The results of the processor consumption benchmark are compared with their nominal power in --REFERENCIA consumo_processadores--.
            
            --TABELA consumo_processadores--
            
            As can be seen, the benchmark results are not coherent for X processors, where the measured/estimated processor power is higher than the nominal power determined by their specifications.
            
        \paragraph*{Analysis of the set processor/chipset/memory power consumption}
            This analysis was conducted with the processor in idle mode, as shown in --REFERENCIA benchIdle-- and with the processor fully stressed, as shown in --REFERENCIA benchStressed.
            
            --TABELA benchIdle--
            --TABELA --benchStressed--
            
            The percentual delta was calculated in absolute values, and as its average is blablablabla
