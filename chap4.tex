...
This section explains how the obtained data was prepared in order to make the comparisons between the various sources of information and exposes the results together with their analysis.
    ...
    \subsection{Data preparation} \label{sec4:data_preparation}
        ...
        \end{itemize}
            ...
            The --REFERENCIA ResultsIdle-- presents the treated measurements that were later used in the comparison.
          
            --TABELA ResultsIdle--
          
          \paragraph*{Stressed processor measure}
              As the stressed processor measure was only made with the monitor powered on, the estimated monitor power will be subtracted from it as shown in equation~\ref{stressed_withoutmonitor}.
            \begin{equation}
                \begin{split}
            ...
            The --REFERENCIA ResultsStressed-- presents the treated measurements that were later used in the comparison.
    ...
    %TODO : colocar as tabelas measurements, benchmark sandra e manufacturer specifications no Appendix (appendix ainda esta em portugues - apendice?)
        The results may be divided into two categories: first the confrontation between the processor consumption measurement by the benchmark and the product specification and secondly the confrontation between the cache and memory benchmark and the direct measurements.
        
        \paragraph*{Processor power analysis}
        %TODO : colocar tabela e referencia
            The results of the processor consumption benchmark are compared with their nominal power in --REFERENCIA ResultsSpecProc--.
            
            --TABELA ResultsSpecProc--
            
            As can be seen, the benchmark results are not coherent for 5 processors, where the measured/estimated processor power is higher than the nominal power determined by their specifications.
        ...
        %TODO : colocar tabelas e referencias
            ...
            This analysis was conducted with the processor in idle mode, as shown in --REFERENCIA ResultsFinalIdle-- and with the processor fully stressed, as shown in --REFERENCIA ResultsFinalStressed.
            
            --TABELA ResultsFinalIdle--
            --TABELA ResultsFinalStressed--
            
            The percentual delta was calculated in absolute values taking the measured consumption as the reference, and its average was of 39\% for the idle processor case and of 23\% for the stressed processor case.
