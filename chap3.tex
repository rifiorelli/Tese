...
\section{Overview} \label{sec3:overview}
    % Acho q seria tb interessante dizer que o banco de dados de componentes vai ser usado como base pra se aplicar uma metodologia de aquisiçao de hardware q ainda vai ser desenvolvida
...
\section{Research Design} \label{sec3:research_design} 
    ...
    %XXX 
    %XXX/********* Os proximos paragraphs foram criados para direcionar o pensamento e deve ser mantidos como comentario, ou retirados do texto é preciso que sejam melhor desenvolvidos*******/
    %XXX
    \begin{description}
