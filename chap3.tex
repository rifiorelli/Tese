...
These can be shortly described as follows:
    \begin{description}
        \item[Phase 0: Project definition -] As this work is part of a project aimed to create a methodology to implement a Green ICT strategy, this first phase consisted of the definition of the logical components of this project and of how the current work would collaborate to it;%analyzed é com Z, ingles EUA, com S ingles britanico.
...
\section{Research Design} \label{sec3:research_design} 
    ...
    In a later stage, all the data acquired by the measurement approaches was separated by categories and components. The database generated is described and furtherer explained in the section~\ref{sec3:data_processing_analysis}.
...
\end{description}
    ...
    \subsection{WebSPHINX - A Personal, Customized Web Crawler} \label{sec3:websphinx}
        ...
        %XXX The set of screens with the configuration used for this software is displayed in Appendix~\ref{app:configuration_websphinx}
