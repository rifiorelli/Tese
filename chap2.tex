...
\footnote{\url{http://www.cosn.org/Initiatives/GreenComputing/EnergyUse/tabid/4515/Default.aspx}}.
    ...
    \end{table}
        ...
        \subsection{Servers and Virtualization} \label{sec2:servers_virtualization}
            ...
            However, the high power density might prove to be a problem to server farms in terms of overheating\footnote{---- falar disso na parte de cooling}.%XXX falar disso na parte de cooling...
