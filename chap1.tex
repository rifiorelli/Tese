...
%TODO
    ...
    Moreover, it represents a study in the analysis of which component is spending more energy and how to change or correct in a efficient way its use.
...
%TODO
    The first step to be taken in the direction of the solution to the problem is data collection. In this phase, it was acquired from many sources data related to the energy consumed by the components 
    
    After that, the next step is data analysis.
