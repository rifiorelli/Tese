...
\section{Definition of the problem} \label{sec1:problem}
    ...
    Moreover, it represents a study in the analysis of which component is spending more energy and how to change or correct in a efficient way its use. Therefore, the aim of this research is to \emph{bla bla bla}%XXX fazer uma frase grande que explique isso.
